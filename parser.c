...
void parse_file ( char * filename,
  ...
  screen s) {
    ...
    while ( fgets(line, sizeof(line), f) != NULL ) {
      ...
      int type;
      double step = 0.05;
      //struct matrix * stk->data[ stk->top ] = new_matrix(4,4);
        ...
        strncmp(line, "bezier", strlen(line)) == 0 ) {
          ...
          free_matrix(tmp);
            ...
            add_edge(tmp, xvals[0], yvals[0], zvals[0],
              ...
              /* printf("%lf %lf %lf\n", */
              /* 	xvals[0], yvals[0], zvals[0]); */
              struct matrix *tmp = make_scale( xvals[0], yvals[0], zvals[0]);
              matrix_mult(stk->data[stk->top], tmp);
              ...
              sscanf(line, "%lf %lf %lf",
              xvals, yvals, zvals);
              struct matrix *tmp = make_translate( xvals[0], yvals[0], zvals[0]);
              matrix_mult(stk->data[stk->top], tmp);
              copy_matrix(tmp, stk->data[stk->top]);
            }//end translate
